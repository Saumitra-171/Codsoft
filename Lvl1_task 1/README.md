...
| Section | Description |
|---------|-------------|
| Header | Name, title, navigation links |
| About | Photo + short bio |
| Skills | HTML, CSS, JS, React, Java, Python, SQL |
| Projects | Stack Overflow Survey, SmartBoard, DevPulse |
| Resume | Modal preview + PDF download |
